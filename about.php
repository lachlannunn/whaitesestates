      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 order-md-2" data-aos="fade-up" data-aos-delay="100">
            <img src="images/advert_allison.jpg" alt="Image" class="img-fluid rounded mb-4">
          </div>
          <div class="col-md-5 mr-auto order-md-1"  data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="site-section-title mb-3">
			  ...
			  <h2 class="mb-2 font-weight-light text-black h4">Allison Whaites</h2>
			 <span class="d-block mb-3 text-white-opacity-05">Sales / Property Manager </span>
			  
                
            <p>Allison is a local Licensed Real Estate Professional, who specialises in office management, Property Sales, both residential and rural, property management and Fair Trading compliance. With many years experience in the local Grafton market and also out of area, allows her to have a well-rounded picture of all facets of the local and national real estate industry.</p>
            <p>All of this experience ensures that Allison achieves the highest quality of service and with her in-depth knowledge and passion for the real estate industry you know you’ll be in the right hands from day one.</p>
			<p>Being a long time Grafton local and having raised her children in the area, Allison enjoys being part of the wider community by fundraising, being involved in charity events, supporting local businesses via social media and hosting free real estate information sessions. She loves the industry's dynamic nature and is determined to excel and reach her real estate goals.</p>
			<p>Allison also enjoys interacting with people, with clients valuing her friendly and supportive nature as well as her drive to deliver the best results possible.</p>
